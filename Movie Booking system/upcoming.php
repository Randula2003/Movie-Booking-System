...
<main>
  <section class="Movies" id="Movies">
    <div class="movies-container">
      <div class="box">
      <div class="box-img">
        <img src="Images/mee.jpg" alt="img">
      </div> 
      <h3>Despicable me</h3>
      <span>non | Animation</span>  
    </div>
    <div class="box">
      <div class="box-img">
        <img src="Images/jo.jpg" alt="img">
      </div> 
      <h3>Joker: Folie à Deux</h3>
      <span>non | Musical</span>  
    </div>
    <div class="box">
      <div class="box-img">
        <img src="Images/si.webp" alt="img">
      </div> 
      <h3>Inside Out 2</h3>
      <span>non | Animation</span>  
    </div>
    <div class="box">
      <div class="box-img">
        <img src="Images/ape.jpg" alt="img">
      </div> 
      <h3>Kingdom Of the planet of the apes</h3>
      <span>non | Action</span>  
    </div>
    </div>
